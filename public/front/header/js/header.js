...
function isLogin(){
	$.getJSON(__ajax_domain+"?action=VnVpd2kzTnltaXlvaElveW5dbHUzdW9Qc3t1cg%3D%3D&callback=?",function(msg){
		if(msg.errorCode == 0 && msg.result.online == 1){
			...
			var html = '<a href="'+__user_domain+'/member/home">'+msg.result.nickname+'</a>	<a href="'+__ajax_domain+'?action=bU5STFIIdUJWUkJUU3JUQlVmV04ITVJKV2tIQE5JaFJTZUJBSFVC&page='+window.location.href+'">退出</a>	<a href="'+__user_domain+'member/home">我的逸香通行证</a>	<a href="javascript:setHomepage()">设为首页</a>';
		}else{
