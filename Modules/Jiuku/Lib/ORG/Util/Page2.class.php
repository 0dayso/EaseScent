...
class Page2
{
    ...
    public function pageHtml() {
        ...
        if ($upRow > 0){
			$theFirst = '<li><span style="cursor:pointer;" onclick="javascript:gotopage(\'1\')"><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt.gif" /><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt.gif" /></span></li>';
			$prePage = '<li><span style="cursor:pointer;" onclick="javascript:gotopage(\''.$upRow.'\');"><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt.gif" /></span></li>';
		}else{
			$theFirst = '<li><span><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt.gif" /><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt.gif" /></span></li>';
            $prePage = '<li><span><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt.gif" /></span></li>';
        }

        if ($downRow <= $this->totalPages){
			$theEnd = '<li><span style="cursor:pointer;" onclick="javascript:gotopage(\''.$theEndRow.'\')"><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt2.gif" /><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt2.gif" /></span></li>';
			$downPage = '<li><span style="cursor:pointer;" onclick="javascript:gotopage(\''.$downRow.'\');"><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt2.gif" /></span></li>';
		}else{
			$theEnd = '<li><span><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt2.gif" /><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt2.gif" /></span></li>';
            $downPage = '<li><span><img src="'.C('DOMAIN.PUBLIC').'Jiuku/images/mingzhuang/detail/z_pageJt2.gif" /></span></li>';
        }
        // << < > >>
        /*
        if($nowCoolPage == 1){
