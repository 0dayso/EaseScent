...
class CommonAction extends BaseAdmin {
	...
	public function _initialize() {
		parent::_initialize();
		$_applist = array(array('id'=>1,'name'=>'大众酒评 IOS'),array('id'=>2,'name'=>'大众酒评 Android'));
		$this->assign('_applist', $_applist);
		$_maxdata = date('Y-m-d',time()-24*60*60);
		$this->assign('_maxdata', $_maxdata);
	}
